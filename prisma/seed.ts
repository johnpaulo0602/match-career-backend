...
async function main() {
  const questions = [
    {
      tipoInteligencia: 'inteligencia_linguistica',
      texto:
    ...
    {
      tipoInteligencia: 'inteligencia_logico_matematica',
      texto:
    ...
    {
      tipoInteligencia: 'inteligencia_espacial',
      texto:
    ...
    {
      tipoInteligencia: 'inteligencia_musical',
      texto:
    ...
    {
      tipoInteligencia: 'inteligencia_corporal_cinestesica',
      texto:
    ...
    {
      tipoInteligencia: 'inteligencia_interpessoal',
      texto:
    ...
    {
      tipoInteligencia: 'inteligencia_intrapessoal',
      texto:
